...
class DesktopExecutionEngine:
    """Native desktop and screen execution engine for VYOM."""
    ...
    async def execute(self, task: Task, profile: TaskProfile, emit: EventEmitter) -> ExecutionResult:
        ...
        raise RuntimeError(f"Unsupported desktop intent: {intent}")
...
Phase9Engine = DesktopExecutionEngine
__all__ = ["DesktopExecutionEngine", "Phase9Engine"]
