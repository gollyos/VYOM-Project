...
class AutomationCreate(BaseModel):
    ...
    def validate_schedule(self) -> "AutomationCreate":
        ...
        if self.type == AutomationType.RECURRING and self.interval_minutes is None:
            raise ValueError("interval_minutes is required for recurring automations")
        ...
        if self.permission_level in {"L2", "L3"}:
